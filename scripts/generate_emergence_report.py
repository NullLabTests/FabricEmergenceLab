...
def generate():
    ...
    with open(REPORT, "w") as f:
        ...
        if wm_latent_norms:
            ...
            f.write("- **WorldModel latent drift**: ")
        ...
        f.write("---\n\n")
        f.write("## Raw Data\n\n")
        f.write("- Step log: `logs/memory_maze.jsonl`\n")
        f.write("- Metrics: `logs/emergence_metrics.jsonl`\n")
        f.write("- Events: `logs/emergence_events.jsonl`\n")
